...
class InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post :create, institution: { city: @institution.city, country: @institution.country, institutionname: @institution.institutionname, state: @institution.state }
    end
  ...
  test "should update institution" do
    put :update, id: @institution, institution: { city: @institution.city, country: @institution.country, institutionname: @institution.institutionname, state: @institution.state }
    assert_redirected_to institution_path(assigns(:institution))
  end
