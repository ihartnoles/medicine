...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { bits: @permission.bits, description: @permission.description, type: @permission.type }
    end
  ...
  test "should update permission" do
    put :update, id: @permission, permission: { bits: @permission.bits, description: @permission.description, type: @permission.type }
    assert_redirected_to permission_path(assigns(:permission))
  end
