...
class FellowshipsControllerTest < ActionController::TestCase
  ...
  test "should create fellowship" do
    assert_difference('Fellowship.count') do
      post :create, fellowship: { location: @fellowship.location, specialty: @fellowship.specialty, training: @fellowship.training }
    end
  ...
  test "should update fellowship" do
    put :update, id: @fellowship, fellowship: { location: @fellowship.location, specialty: @fellowship.specialty, training: @fellowship.training }
    assert_redirected_to fellowship_path(assigns(:fellowship))
  end
